...
public final class ScheduledRecording {
	...
	public static ScheduledRecording observed(final SimulationState initial, final WorldSnapshot world,
		...
		var trace = new ScheduledRecording(initial, world, version, mayInteract, source, false);
	...
	public ScheduledRecording recomputeKernel(final BlockStateCatalog.Source source) {
		...
		var updated = new ScheduledRecording(this.initial, this.world, this.version, this.mayInteract, source);
	...
	public static ScheduledRecording read(
		...
		try (var in = new DataInputStream(new GZIPInputStream(Files.newInputStream(path)))) {
			...
			ScheduledRecording trace =
			    new ScheduledRecording(initial, world, version, permission < 0 ? null : permission == 1, source, false);

...
/**
 * A cauldron full of lava: {@code LavaCauldronBlock.entityInside}, which
 * collects CLEAR_FREEZE on both sides, applied to each side's own frozen
 * count by {@code applyAndClear}, and, on the server, ignites and hurts as
 * lava does, behind {@code getEntityInsideCollisionShape}, which is the
 * filled bowl rather than the cube and so has to be swept for.
 *
...
final class LavaCauldronBlock extends BlockBehaviour {
	...
	private static final double[] FILLED_SHAPE = {
	    ...
	    0.0, 15.0 / 16.0, 0.0, 0.125, 1.0, 1.0, 0.875, 15.0 / 16.0, 0.0, 1.0, 1.0, 1.0, 0.125, 15.0 / 16.0, 0.0, 0.875,
	    1.0, 0.125, 0.125, 15.0 / 16.0, 0.875, 0.875, 1.0, 1.0,
	    // AbstractCauldronBlock's four L-shaped feet below the bowl floor.
	    0.0, 0.0, 0.0, 0.125, 3.0 / 16.0, 0.25, 0.125, 0.0, 0.0, 0.25, 3.0 / 16.0, 0.125, 0.875, 0.0, 0.0, 1.0,
	    3.0 / 16.0, 0.25, 0.75, 0.0, 0.0, 0.875, 3.0 / 16.0, 0.125, 0.0, 0.0, 0.75, 0.125, 3.0 / 16.0, 1.0, 0.125, 0.0,
	    0.875, 0.25, 3.0 / 16.0, 1.0, 0.875, 0.0, 0.75, 1.0, 3.0 / 16.0, 1.0, 0.75, 0.0, 0.875, 0.875, 3.0 / 16.0, 1.0};

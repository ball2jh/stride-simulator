...
class WorldEvidenceAdmissionTest {
	private static String world() throws IOException {
		var air = WorldSnapshot.BlockEntry.builder(0, "minecraft:air").build();
		var water =
		    new WorldSnapshot.FluidEntry(1, "minecraft:water", WorldSnapshot.FluidKind.WATER, 1.0, 0.0, 0.0, 0.0, true);
		var snapshot = new WorldSnapshot(0, 0, 0, 1, 2, 1, WorldSnapshot.OutsideRegion.SEALED, List.of(air),
		    new int[] {0, 0}, List.of(WorldSnapshot.FluidEntry.EMPTY, water), new int[] {1, 1});
